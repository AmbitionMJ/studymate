...
public class MainController {
    ...
    @GetMapping("/")
    public String home(@AuthenticationPrincipal UserAccount userAccount , Model model, Pageable pageable){
        ...
        Page<BoardDto> boardDtoPage = boardService.getPostPage(pageable);
